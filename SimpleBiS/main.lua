...
SBL.spec_icon_table = {
    ...
    ["DRUID_guardian"] = 'interface/icons/ability_racial_bearform.blp',
    ["DRUID_feral combat"] = 'interface/icons/ability_druid_catform.blp',
    ["DRUID_restoration"] = 'interface/icons/spell_nature_healingtouch.blp',
    ["HUNTER_beast mastery"] = 'interface/icons/ability_hunter_bestialdiscipline.blp',
    ["HUNTER_marksmanship"] = 'interface/icons/ability_hunter_focusedaim.blp',
    ["HUNTER_survival"] = 'interface/icons/ability_hunter_camouflage.blp',
    ...
    ["PALADIN_protection"] = 'interface/icons/ability_paladin_shieldofthetemplar.blp',
    ...
    ["PRIEST_holy"] = 'interface/icons/spell_holy_guardianspirit.blp',
    ["PRIEST_discipline"] = 'interface/icons/spell_holy_powerwordshield.blp',
    ...
    ["SHAMAN_enhancement"] = 'interface/icons/spell_shaman_improvedstormstrike.blp',
    ...
    ["WARRIOR_protection"] = 'interface/icons/ability_warrior_defensivestance.blp',
    ["WARRIOR_arms"] = 'interface/icons/ability_warrior_savageblow.blp',
    ...
    ["MONK_brewmaster"] = 'interface/icons/monk_stance_drunkenox.blp',
    ["MONK_mistweaver"] = 'interface/icons/monk_stance_wiseserpent.blp',
    ["MONK_windwalker"] = 'interface/icons/spell_monk_windwalker_spec.blp'
}
